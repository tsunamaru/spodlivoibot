        ...
        if (first) {
            ...
            if (upSize < 0) {
                ...
                switch (messageNumber) {
                    ...
                    case 2:
                        return "Ты испугалась планового приёма гениколога и не шликала целых " +
                                Randomizer.getRandomNumberInRange(5, 9) + " дней, от чего твоя вагина стала уменьшилась на " +
                                Math.abs(upSize) + "см.\n" +
                                "Теперь её глубина составляет " + size + "см!";
                    case 3:
                        return "Батя решил напоить тебя лечебными траваими, от чего твоя вагина сузилась на " +
                                Math.abs(upSize) + "см.\n" +
                                "Ты заработала камни в почках и размер твоей вагины теперь составляет " + size + "см.\n" +
                ...
                switch (messageNumber) {
                    ...
                    case 1:
                        return "После длинного *BBC*, у тебя жуткий разрыв вагины на " + Math.abs(upSize) + "см.\n" +
                                "Теперь твоя вагина стала " + size + " см. Не забудь посетить гинеколога!";
                    case 2:
                        return "Ты подскользнулась в ванной и случайно упала на " + item +
                                " длинной " + Math.abs(upSize) + "см.\nТеперь глубина твоей вагины аж " + size + "см.\n" +
