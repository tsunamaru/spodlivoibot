    ...
    String getRollMessage(boolean first, int size, int upSize) {
        if (first) {
            if (size == 0) {
                ...
                return "Ахуеть! ширина твоего ануса аж " + size +
            ...
            if (upSize < 0) {
                ...
                switch (messageNumber) {
                    case 0:
                        return "Прорыв в медицине! Твой анус подшили и его глубина уменьшилась на целых " +
                                Math.abs(upSize) +
                                "см.\nТеперь он всего лишь " + size + "см.";
                    case 1:
                        return "Одиночество даёт о себе знать, и раны былой любви начинают затягиваться.\n" +
                                "Твое очко восстановилось на " + Math.abs(upSize) + "см, и теперь его глубина " + size +
                                "см.\n" +
                ...
                switch (messageNumber) {
                    ...
                    case 5:
                        return "*ЧУДОВИЩНЫЙ РАЗРЫВ АНУСА!* Сегодня он стал больше аж на " + Math.abs(upSize) + "см!\n" +
                                ...
                                "\nИнтересно, как он там оказался? В любом случае теперь ширина твоего ануса " +
                                "составляет " + size + "см.";
                }
            }
        }
