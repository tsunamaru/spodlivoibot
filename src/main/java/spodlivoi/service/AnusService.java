        ...
        if (first) {
            ...
            if (upSize < 0) {
                ...
                switch (messageNumber) {
                    ...
                    case 3:
                        return "Ты долго сидел на холодной плите, от чего твой внус сжался на " + upSize + "см.\n" +
                ...
                switch (messageNumber) {
                    ...
                    case 5:
                        return "*ЧУДОВИЩНЫЙ РАЗРЫВ АНУСА!* Сегодня он стал больше аж на " + upSize + "см!\n" +
                                ...
                                "\nИнтересно, как он там оказался? В любом случае теперь глубина твоего ануса составляет" + size;
                }
            }
        }
        return "Пиздец...";
